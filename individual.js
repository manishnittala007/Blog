...
function createItem(text) {
    ...
    dropItem.addEventListener('click', function () {
        ...
        switch (text.toLowerCase()) {
            ...
            case 'facebook':
                var facebookShareLink = 'https://www.facebook.com/sharer/sharer.php?u=' + encodeURIComponent(imageSource);
...
function createSliderDiv() {
    ...
    slider.step = '1';
    slider.value = '1';
    slider.classList.add('custom-range','mx-2','mt-3');
...
function createCardBtn(blog) {
    ...
    cardBtn.classList.add('btn', 'btn-primary', 'mx-3');
    cardBtn.style.borderRadius = '10%';
    cardBtn.style.float = 'right';
    cardBtn.textContent = blog.category;
    return cardBtn;
}
